...
<body>
	...
	<table class="table table-striped table-bordered mt-3">
		...
		<tr>
			<td>2</td>
			<td>Gaji Bonus</td>
			<td>Rp. <?php echo number_format($ps->bonus_gaji,0,',','.') ?></td>
		</tr>

		<tr>
			<td>3</td>
			<td>PPh 5%</td>
			<td>Rp. <?php echo number_format(($ps->gaji_pokok + $ps->bonus_gaji)* 0.05,0,',','.')?></td>
		</tr>

		<tr>
			<th colspan="2" style="text-align: right;">Total Gaji : </th>
			<th>Rp. <?php echo number_format(($ps->gaji_pokok + $ps->bonus_gaji) - ($ps->gaji_pokok + $ps->bonus_gaji)* 0.05,0,',','.')?></th>
		</tr>
	</table>
